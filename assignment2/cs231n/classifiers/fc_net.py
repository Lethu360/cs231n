...
class TwoLayerNet(object):
    ...
    def __init__(
        ...
        - weight_scale: Scalar giving the standard passength.
        """
        self.params = {}
        self.reg = reg
    ...
    def loss(self, X, y=None):
        ...
        dx2, dw2, db2 = affine_backward(softmax_grad, affine2_cache)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers-1):
          ...
          x, cache = affine_norm_relu_drop_forward(x, w, b, gamma, beta, bn_param, self.normalization, self.use_dropout, self.dropout_param)
          caches.append(cache)
        ...
        for i in range(self.num_layers-2, -1, -1):
          dx, dw, db, dgamma, dbeta = affine_norm_relu_drop_backward(dout, caches[i], self.normalization, self.use_dropout)
...
def affine_norm_relu_drop_forward(x, w, b, gamma, beta, bn_param, normalization, dropout, do_param):
